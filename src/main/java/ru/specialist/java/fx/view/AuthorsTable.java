...
/**
 * Класс описывающий вывод БД в виде таблицы
 */
public class AuthorsTable extends Application {
    ...
    public static final String UPDATE_AUTHOR_NAME = "update authors set author_name = ? where author_id = ?";
    public static final String UPDATE_LAST_NAME = "update authors set last_name = ? where author_id = ?";
    ...
    public void start(Stage stage) {
        ...
        try(Connection c = DriverManager.getConnection(URL, LOGIN, PASSWORD)){
            ...
            ResultSet set = statement.executeQuery("select author_id, author_name, last_name from authors");
            while (set.next()){
